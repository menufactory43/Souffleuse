...
final class SouffleuseAppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func tick() {
        ...
        // key sur une étape à champ d'essai (« Comment ça marche » pour le souffle,
        // « Pour aller plus loin » pour // et :), on laisse tourner — le seul champ
        // focusable y est un NSTextField AppKit (AX fiable), et c'est tout l'objet
        // de l'étape : essayer pour de vrai avant de sortir du wizard.
